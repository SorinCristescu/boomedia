...
import './App.css';
import btn_icon_346559 from './images/btn_icon_346559.png';
...
export default class GetAQuoteScreen extends Component {
  ...
  render() {
    ...
    const style_iconButton = {
        display: 'block',
        backgroundImage: 'url('+btn_icon_346559+')',
    ...
    return (
      <div className="AppScreen GetAQuoteScreen" style={baseStyle}>
        ...
        <div className="screenFgContainer">
          <div className="foreground">
            ...
            <div className='headlineFont elTextBlock' style={style_textBlock}>
              <div>{this.props.locStrings.getaquote_textblock_512830}</div>
            </div>
          </div>
        </div>
      </div>
