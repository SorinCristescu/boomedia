...
import './App.css';
import btn_icon_139610 from './images/btn_icon_139610.png';
...
import btn_icon_784408 from './images/btn_icon_784408.png';
import btn_icon_820770 from './images/btn_icon_820770.png';


export default class FreeConsultationTimeScreen extends Component {
  ...
  onClick_elFab = (ev) => {
    // Go to screen 'Free consultation form'
    this.props.appActions.goToScreen('freeconsultationform', { transitionId: 'fadeIn' });
  ...
  render() {
    ...
    const style_iconButton = {
        display: 'block',
        backgroundImage: 'url('+btn_icon_139610+')',
    ...
    const style_fab = {
        display: 'block',
        backgroundImage: 'url('+btn_icon_784408+')',
        backgroundRepeat: 'no-repeat',
    ...
    const style_fabCopy = {
        display: 'block',
        backgroundImage: 'url('+btn_icon_820770+')',
        backgroundRepeat: 'no-repeat',
        backgroundSize: '39.751%',
        paddingTop: '30%',
        backgroundPosition: '50% 0%',
    ...
    return (
      <div className="AppScreen FreeConsultationTimeScreen" style={baseStyle}>
        ...
        <div className="screenFgContainer">
          <div className="foreground">
            ...
            <div className='headlineFont elTextBlock' style={style_textBlock}>
              <div>{this.props.locStrings.freeconsultationtime_textblock_795270}</div>
            </div>
            <button className='elFab' style={style_fab}  onClick={this.onClick_elFab} >
              {this.props.locStrings.freeconsultationtime_fab_784408}
            </button>
            <button className='elFabCopy' style={style_fabCopy}  onClick={this.onClick_elFabCopy} >
              {this.props.locStrings.freeconsultationtime_fabcopy_820770}
            </button>
          </div>
        </div>
      </div>
