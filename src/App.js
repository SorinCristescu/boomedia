...
import OurProcessScreen from './OurProcessScreen.js';
import WorksScreen from './WorksScreen.js';
import LetsTalkScreen from './LetsTalkScreen.js';
import ContactScreen from './ContactScreen.js';
import FreeConsultationTimeScreen from './FreeConsultationTimeScreen.js';
import FreeConsultationDayScreen from './FreeConsultationDayScreen.js';
import GetAQuoteScreen from './GetAQuoteScreen.js';
import FreeConsultationFormScreen from './FreeConsultationFormScreen.js';
  ...
  render() {
    let makeElementForScreen = (screenId, baseProps, atTop, forward) => {
      ...
      switch (screenId) {
        ...
        case 'ourprocess':
          return (<OurProcessScreen {...screenProps} />)
        case 'works':
          return (<WorksScreen {...screenProps} />)
        case 'letstalk':
          return (<LetsTalkScreen {...screenProps} />)
        case 'contact':
          return (<ContactScreen {...screenProps} />)
        case 'freeconsultationtime':
          return (<FreeConsultationTimeScreen {...screenProps} />)
        case 'freeconsultationday':
          return (<FreeConsultationDayScreen {...screenProps} />)
        case 'getaquote':
          return (<GetAQuoteScreen {...screenProps} />)
        case 'freeconsultationform':
          return (<FreeConsultationFormScreen {...screenProps} />)
        case 'about':
